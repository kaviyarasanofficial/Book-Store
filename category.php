...
<hr style="border-top: 3px solid #f8f8f5ef; width:100%;">
		<h1 class="display-4 p-3 fs-3"> 
			...
			<span style="color: white;"><?=$current_category['name']?></span>
		</h1>
		<div class="d-flex pt-3">
			...
			<div class="pdf-list d-flex flex-wrap">
				...
				<div class="card m-1">
					<img src="uploads/cover/<?=$book['cover']?>" style="height: 200px; width: 150px; display: block; margin-left: auto; margin-right: auto;"
					     class="card-img-top">
					<div class="card-body">
						<h5 class="card-title">
							<?=$book['title']?>
